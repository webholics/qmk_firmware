...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		[0] = LAYOUT_65_ansi_blocker(
		    ...
		    KC_LCTL,        KC_LALT,    KC_LGUI,                  KC_SPC,                         KC_RGUI,  MO(2),        KC_LEFT,           KC_DOWN,   KC_RIGHT),
		[1] = LAYOUT_65_ansi_blocker(
			TO(0),         UC_M_MA,     UC_M_WC,    UC_M_LN,KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,  KC_TRNS,
		...
		[2] = LAYOUT_65_ansi_blocker(
		    ...
		    KC_TRNS,       KC_TRNS,                     KC_TRNS,        KC_TRNS,KC_TRNS, KC_TRNS, KC_TRNS, XP(UM_LC_UE, UM_UC_UE),  KC_TRNS, XP(UM_LC_OE, UM_UC_OE),    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,  TO(1),
			KC_TRNS,       XP(UM_LC_AE, UM_UC_AE),      X(UM_LC_SS),    KC_TRNS,KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                 KC_TRNS, KC_TRNS,                   KC_TRNS,    KC_TRNS,                KC_TRNS,  KC_TRNS,
